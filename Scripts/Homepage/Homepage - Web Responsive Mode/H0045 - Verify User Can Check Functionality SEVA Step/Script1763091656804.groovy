...
WebUI.scrollToElement(findTestObject('Homepage Component/how_to_use_Cara Dapatkan Mobil Impian di SEVA'), 0)
...
WebUI.click(findTestObject('Homepage Component/how_to_use-hitung kemampuan'))
