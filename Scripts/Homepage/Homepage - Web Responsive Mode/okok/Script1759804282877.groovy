...
WebUI.executeJavaScript(
	"document.querySelector('input.input_input__cOtP8').value = '100000';" +
	"document.querySelector('input.input_input__cOtP8').dispatchEvent(new Event('input', { bubbles: true }));",
	null
)