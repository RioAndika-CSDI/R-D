...
WebUI.scrollToElement(findTestObject('Page_SEVA (sevaid_official)  X/Page_SEVA - Beli Mobil Baru Dengan Cicilan _bf97c5/svg_SEVA Twitter Icon'), 
    0)
...
if (url.contains('https://x.com/sevabyastra')) {
