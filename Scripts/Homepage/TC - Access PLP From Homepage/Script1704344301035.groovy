...
WebUI.click(findTestObject('Homepage Component/Button Cari Mobil Baru'))

WebUI.verifyElementVisibleInViewport(findTestObject('Product List Page Component/Text Rekomendasi Mobil Baru di SEVA'), 
    0)
