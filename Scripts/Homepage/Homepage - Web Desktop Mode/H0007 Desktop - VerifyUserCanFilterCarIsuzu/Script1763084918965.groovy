...
WebUI.click(findTestObject('Page_SEVA (sevaid_official)  X/Page_SEVA - Beli Mobil Baru Dengan Cicilan _bf97c5/span_Isuzu'))
...
WebUI.verifyMatch(Url_act, 'https://www.seva.id/mobil-baru?brand=Isuzu', false)
