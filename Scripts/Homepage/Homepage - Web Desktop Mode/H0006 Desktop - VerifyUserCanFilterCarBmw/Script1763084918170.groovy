...
WebUI.click(findTestObject('Page_Beli Mobil Baru 2024 - Harga OTR denga_f888ac/span_BMW'))
...
WebUI.verifyMatch(Url_act, 'https://www.seva.id/mobil-baru?brand=BMW', false)
