...
WebUI.click(findTestObject('CRM/Homepage/Fasilitas Dana -Homepage/Tab Fasilitas Dana'))

WebUI.click(findTestObject('CRM/Homepage/Fasilitas Dana -Homepage/button ajukan sekarang'))
