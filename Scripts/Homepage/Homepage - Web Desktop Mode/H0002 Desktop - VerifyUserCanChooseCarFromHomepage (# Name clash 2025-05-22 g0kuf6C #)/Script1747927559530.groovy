...
WebUI.mouseOver(findTestObject('1. Homepage Desktop Mode/navbar-mobil baru'))

WebUI.waitForElementVisible(findTestObject('1. Homepage Desktop Mode/navbar-submenu-lihat semua mobil'), 
    10)
