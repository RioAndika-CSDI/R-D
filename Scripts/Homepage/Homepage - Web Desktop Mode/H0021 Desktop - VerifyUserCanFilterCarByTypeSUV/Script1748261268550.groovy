...
WebUI.click(findTestObject('Homepage Desktop Mode/smart filter - select car type', [('type') : 'suv']))
...
WebUI.verifyElementPresent(findTestObject('PLP - Desktop Mode/Selected Car Type', [('type') : 'SUV']), 0)
