...
WebUI.click(findTestObject('Homepage Desktop Mode/smart filter - brand'))
...
WebUI.click(findTestObject('Homepage Desktop Mode/button-tambah-filter-finansial'))

WebUI.click(findTestObject('Homepage Desktop Mode/batalkan filter financial'))
...
WebUI.verifyElementPresent(findTestObject('Homepage Component/smart filter - all brand selected'), 0)
