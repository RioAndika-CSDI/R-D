...
WebUI.click(findTestObject('Object Repository/Page_SEVA (sevaid_official)  X/Page_SEVA - Beli Mobil Baru Dengan Cicilan _bf97c5/div_Isuzu'))
...
if (findTestObject('Object Repository/Page PLP Mobil Baru/Empty State title - Tidak ada mobil')) {
    WebUI.comment('Passed : Car brand might be unavailable')

    WebUI.closeBrowser()
} else {
    WebUI.verifyElementPresent(findTestObject('PLP - Desktop Mode/Selected Car Brand', [('brand') : 'isuzu']), 0)
