...
WebUI.click(findTestObject('Page_SEVA (sevaid_official)  X/Page_SEVA - Beli Mobil Baru Dengan Cicilan _bf97c5/span_Daihatsu'))
...
WebUI.verifyElementPresent(findTestObject('Homepage Desktop Mode/button_daihatsu'), 0)
