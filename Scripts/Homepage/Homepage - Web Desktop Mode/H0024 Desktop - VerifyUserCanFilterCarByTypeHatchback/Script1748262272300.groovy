...
WebUI.click(findTestObject('Homepage Desktop Mode/smart filter - select car type', [('type') : 'hatchback']))
...
if (findTestObject('Object Repository/Page PLP Mobil Baru/Empty State title - Tidak ada mobil')) {
    ...
    WebUI.verifyElementPresent(findTestObject('PLP - Desktop Mode/Selected Car Type', [('type') : 'Hatchback']), 0)
