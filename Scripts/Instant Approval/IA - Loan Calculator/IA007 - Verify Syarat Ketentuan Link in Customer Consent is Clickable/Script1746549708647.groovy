...
WebUI.click(findTestObject('InstantApproval/InstantApproval/a_Syarat  Ketentuan'))

WebUI.delay(3)

String currentUrl_snk = WebUI.getUrl()

String snkUrl = 'https://www.seva.id/info/syarat-dan-ketentuan/'

if (currentUrl_snk == snkUrl) {
    KeywordUtil.markPassed('User is on the expected page: ' + currentUrl_snk)
}
