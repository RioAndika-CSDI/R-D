...
if (spouse_ktp == '1') {
    if (WebUI.verifyElementPresent(findTestObject('InstantApproval/InstantApproval/add-spouse-ktp'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.setText(findTestObject('InstantApproval/InstantApproval/input_ktp edit_name'), 'automation testing spouse')

        WebUI.setText(findTestObject('InstantApproval/InstantApproval/input_Kota_city'), kota_ktp)

        WebUI.click(findTestObject('InstantApproval/InstantApproval/dropdown city edit ktp', [('kota') : kota_ktp]))

        WebUI.scrollToElement(findTestObject('InstantApproval/InstantApproval/input_Status Perkawinan_marriage'), 5)
        ...
        WebUI.click(findTestObject('InstantApproval/InstantApproval/button Sudah Sesuai KTP'))
    } else if (WebUI.verifyElementNotPresent(findTestObject('InstantApproval/InstantApproval/add-spouse-ktp'), 5)) {
        println('Spouse KTP already filled')
    }
} else {
    println('Single')
}
...
WebUI.click(findTestObject('Object Repository/InstantApproval/InstantApproval/spouse_ktp_rb'))
...
String IAprocess_url = 'https://www.seva.id/instant-approval/review'

if (currentUrl_IAprocess == IAprocess_url) {
    KeywordUtil.markPassed('User is on the expected page: ' + currentUrl_IAprocess)
}
...
'\r\n'
WebUI.click(findTestObject('InstantApproval/InstantApproval/sidebarMobile_profileContent'))

WebUI.delay(5)

WebUI.click(findTestObject('InstantApproval/InstantApproval/account-profile_deleteAccountLink'))

WebUI.delay(5)

WebUI.click(findTestObject('InstantApproval/InstantApproval/delete-account_checkboxSection'))

WebUI.click(findTestObject('InstantApproval/InstantApproval/Lanjutkan-delete account'))

WebUI.delay(5)

WebUI.click(findTestObject('InstantApproval/InstantApproval/Alasan hapus akun input'))

WebUI.click(findTestObject('InstantApproval/InstantApproval/Alasan hapus akun value'))

WebUI.click(findTestObject('InstantApproval/InstantApproval/Selanjutnya-delete account'))
...
WebUI.click(findTestObject('Login Register Component/Input_Phone_Number'))

if ((os[0]).equalsIgnoreCase('Windows') || (os[0]).equalsIgnoreCase('Linux')) {
    WebUI.sendKeys(findTestObject('Login Register Component/Input_Phone_Number'), Keys.chord(Keys.CONTROL, 'a'))
} else {
    WebUI.sendKeys(findTestObject('Login Register Component/Input_Phone_Number'), Keys.chord(Keys.COMMAND, 'A'))
}

//WebUI.sendKeys(findTestObject('Kualifikasi-Kredit/Loan-Calculator/input city empty field'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Login Register Component/Input_Phone_Number'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.waitForElementPresent(findTestObject('InstantApproval/InstantApproval/Register/register-header-text'), 15)

WebUI.setText(findTestObject('InstantApproval/InstantApproval/Register/input-nama-lengkap'), 'testing register automation')

WebUI.setText(findTestObject('InstantApproval/InstantApproval/Register/input-email'), 'testingregister@gmail.com')

CustomKeywords.'selector_dob.DatePickerHandler_Register.selectDate'('2000', 'April', '06')

WebUI.scrollToElement(findTestObject('InstantApproval/InstantApproval/Register/customer-consent-sk'), 0)

WebUI.click(findTestObject('InstantApproval/InstantApproval/Register/customer-consent-sk'))

WebUI.click(findTestObject('InstantApproval/InstantApproval/Register/button-daftar'))
