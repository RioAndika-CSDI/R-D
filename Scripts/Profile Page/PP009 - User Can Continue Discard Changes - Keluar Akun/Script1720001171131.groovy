...
WebUI.click(findTestObject('Profile/Profile_Page/Profile Page - Pop Up Screen/Page_/button_Batalkan perubahan dan lanjutkan'))

String currentUrl = WebUI.getUrl()

// Define the expected URL
String expectedUrl = 'https://www.seva.id/'
