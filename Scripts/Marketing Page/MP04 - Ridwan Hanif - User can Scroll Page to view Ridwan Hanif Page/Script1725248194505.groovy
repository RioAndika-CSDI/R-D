...
WebUI.scrollToElement(findTestObject('Marketing Page/footer_ridwan_hanif_page'), 10)

WebUI.delay(3)

if(WebUI.verifyElementPresent(findTestObject('Marketing Page/footer_ridwan_hanif_page'), 5)) {
