...
List<WebElement> buttons = WebUiCommonHelper.findWebElements(
    new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@data-testid='button-lihat-detail']"),
    10
)

println("Jumlah button-lihat-detail ketemu: " + buttons.size())
