...
WebUI.setText(findTestObject('Object Repository/Multi KK/input_Rp2.659.100.000_monthlyIncome'), 
    'Rp2.000.000')

'error message'
WebUI.verifyElementVisible(findTestObject('Page_SEVA - Beli Mobil Terbaru Dengan Cicilan Kredit Terbaik/span_Pendapatan yang kamu masukkan terlalu rendah'))
