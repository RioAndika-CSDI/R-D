...
WebUI.click(findTestObject('Page_CMS_new/Page_Run_Simulation/Mobil_Commercial/value_asuransi_tenor3_2TahunComprehensive1TahunTLO'))
...
//
//WebUI.delay(5)
WebUI.click(findTestObject('Page_CMS_new/Page_Run_Simulation/Mobil_Commercial/value_asuransi_tenor4_2TahunComprehensive2TahunTLO'))
