...
WebUI.setText(findTestObject('Object Repository/Page_CMS_new/Page_Run_Simulation/Page_SEVA CMS/Page_SEVA CMS/input_tipeasuransiTenor3'), 
    '2 tahun comprehensive')

WebUI.delay(5)

WebUI.click(findTestObject('Page_CMS_new/Page_Run_Simulation/Page_SEVA CMS/value_asuransi_tenor3_2TahunComprehensive1TahunTLO'))
...
//
//WebUI.delay(5)
WebUI.click(findTestObject('Page_CMS_new/Page_Run_Simulation/Page_SEVA CMS/value_asuransi_tenor4_2TahunComprehensive2TahunTLO'))
