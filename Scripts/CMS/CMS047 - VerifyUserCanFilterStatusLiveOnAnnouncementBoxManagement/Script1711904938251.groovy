...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Live Announcement Box Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Live List Announcement Box Management'), 
        3)
}
