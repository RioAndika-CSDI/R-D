...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Select_Request Status Testimony Mangament'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Request to Publish Testimony Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Apply Filter Testimony Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Request to Unpublish List Testimony Management'), 
        3)
}
