...
WebUI.click(findTestObject('Page_CMS_new/Page_Testimony_Management/svg_Request_Status_Select (1)'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Request to Publish Testimony Management'))

WebUI.click(findTestObject('Page_CMS_new/Page_Testimony_Management/button_Apply Filter'))
