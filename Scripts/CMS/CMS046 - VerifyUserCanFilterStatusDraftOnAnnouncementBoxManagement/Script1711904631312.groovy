...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Draft Announcement Box Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/button_Apply Filter announcement box 1'))

if (true) {
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Draft List Announcement Box Management'), 
        3)
} else {
