...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Deleted Homepage Banner Management'))
...
if (true) {
	...
	WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Deleted List Homepage Banner Management'),
		0)
}
