...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Clone Homepage Banner Management'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/h1_Clone Homepage Banner Management'), 
    'Clone Homepage Banner')
