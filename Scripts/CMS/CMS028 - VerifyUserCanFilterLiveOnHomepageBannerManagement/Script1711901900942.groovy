...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Live Homepage Banner management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Live List Homepage Banner management'), 
        0)
}
