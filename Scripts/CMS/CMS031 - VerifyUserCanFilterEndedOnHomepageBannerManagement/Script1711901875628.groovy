...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Ended Homepage Banner Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Ended List Homepage Banner Management'), 
        3)
}
