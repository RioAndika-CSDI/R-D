...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Car of the Month/input_Search Car of the Month Management'))

WebUI.verifyElementVisibleInViewport(findTestObject('Page_CMS_new/Page_Car_of_the_Month/Page_SEVA CMS/svg_Car of the Month Management'), 
    0)
...
WebUI.click(findTestObject('Page_CMS_new/Page_Car_of_the_Month/Page_SEVA CMS/svg_Car of the Month Management'))

if (true) {
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Car of the Month/td_Car List Car of the Month Management'), 
        0)
} else {
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Car of the Month/span_Showing 0-0 of 0 Toyota Car of the Month Management'), 
        0)
