...
WebUI.click(findTestObject('Page_CMS_new/Page_Testimony_Management/button_Clone_TM'))

WebUI.verifyElementText(findTestObject('Page_CMS_new/Page_Testimony_Management/h1_Clone Testimony'), 'Clone Testimony')
