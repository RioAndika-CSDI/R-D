...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Clone Testimony Management'))

WebUI.verifyElementText(findTestObject('Page_SEVA CMS/CMS - Testimony Management/h1_Clone Testimony Management'), 'Clone Testimony')
