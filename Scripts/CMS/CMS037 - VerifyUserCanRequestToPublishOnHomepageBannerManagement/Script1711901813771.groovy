...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Publish Testimony Management'))

WebUI.verifyElementText(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Send Request Homepage Banner Management'), 
    'Send Request')

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Send Request Homepage Banner Management'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/li_Approval request has been sent Homepage Banner Management'), 
    2)

WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_This entry has a pending request to publish Homepage Banner Management'), 
    2)
...
WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Request to Publish Homepage Banner Management'), 
    0)
