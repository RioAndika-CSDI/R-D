...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Cancel Approval Request Testimony Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Yes, Cancel Request Testimony Management'))

WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Entry have been cancelled Testimony Management'), 
    2)

WebUI.verifyElementVisible(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Publish Testimony Management'))
...
WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_- Testimony management'), 
    0)
