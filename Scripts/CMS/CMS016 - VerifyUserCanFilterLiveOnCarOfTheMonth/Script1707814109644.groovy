...
WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_APPLY FILTER'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_Toyota'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_Daihatsu'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_Isuzu'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_BMW'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_Peugeot'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/span_LIVE'))

WebUI.click(findTestObject('Object Repository/Page_SEVA CMS/div_Hyundai'))
