...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Request to Unpublish Announcement Box Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Request to Unpublish List Announcement Box Management'), 
        3)
}
