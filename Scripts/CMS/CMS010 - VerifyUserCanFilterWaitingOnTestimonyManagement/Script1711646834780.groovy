...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Waiting Testimony Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Waiting List Testimony Management'), 
        3)
}
