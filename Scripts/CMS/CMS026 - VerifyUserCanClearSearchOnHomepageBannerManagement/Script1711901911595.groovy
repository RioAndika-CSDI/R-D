...
WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/svg_Icon X Search Homepage Banner Management'), 
    0)
...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/svg_Icon X Search Homepage Banner Management'))
