...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/input_search Homepage Banner Management'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisibleInViewport(findTestObject('Page_CMS_new/Page_Homepage_Banner_Management/Page_SEVA CMS/svg_Homepage Banner Management'), 
    0)

WebUI.setText(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/input_search Homepage Banner Management'), 
    'SEVA Layanan Edokumen')
...
WebUI.click(findTestObject('Page_CMS_new/Page_Homepage_Banner_Management/Page_SEVA CMS/svg_Homepage Banner Management'))

if (true) {
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_List Banner Name Homepage Banner Management'), 
        0)
} else {
