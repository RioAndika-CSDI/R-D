...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/td_Request to Publish List Homepage Banner Management'), 
        3)
}
