...
WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/input_Search Testimony Management'), 
    0)
...
if (true) {
    WebUI.verifyElementText(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_List NameTestimony Management'), 
        'Gati Wibowo')
} else {
