...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Edit Homepage Banner Management'))

WebUI.verifyElementText(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/h1_Edit Announcement Box'), 'Edit Announcement Box')
