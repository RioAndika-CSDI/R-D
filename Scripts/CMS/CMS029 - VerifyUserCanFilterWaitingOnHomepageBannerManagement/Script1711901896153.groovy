...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Waiting Homepage Banner management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/div_Waiting List Homepage Banner Management'), 
        3)
}
