...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Deleted Testimony Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Apply Filter Testimony Management'))

if (true) {
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Deleted List Testimony Management'), 
        3)
} else {
