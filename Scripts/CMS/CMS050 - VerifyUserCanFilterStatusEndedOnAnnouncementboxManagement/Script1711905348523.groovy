...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Ended announcement'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Announcement Box Management/div_Ended List Announcement Box Management'), 
        3)
}
