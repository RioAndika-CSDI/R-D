...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Delete Testimony Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/button_Yes, Delete Testimony Management'))

WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Entry have been deleted successfully Testimony Management'), 
    0)
