...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Delete Homepage Banner Management'))

WebUI.click(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/button_Yes, Delete Homepage Banner Management'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Homepage Banner Management/li_Entry have been deleted successfully Homepage Banner Management'), 
    2)
