...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Ended Testimony Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Ended List Testimony Management'), 
        3)
}
