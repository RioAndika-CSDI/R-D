...
WebUI.click(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Live Testimony Management'))
...
if (true) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('Page_SEVA CMS/CMS - Testimony Management/div_Live List Testimony Management'), 
        3)
}
