...
WebUI.scrollToElement(findTestObject('Homepage Component/bottom_widget_cari_mobil_cta'), 2)
...
WebUI.click(findTestObject('Object Repository/Homepage - PLP/promo_container'))
