...
WebUI.click(findTestObject('Object Repository/Homepage - PLP/Header Page/city_bandung'))

WebUI.click(findTestObject('Object Repository/Homepage - PLP/Header Page/btn_mulai_cari_mobil'))
