...
WebUI.click(findTestObject('Promo Page/Dropdown_promo'))

WebUI.click(findTestObject('Promo Page/dropdown_text_terbaru'))

String currentUrl = WebUI.getUrl()

String expectedUrl = 'https://www.seva.id/info/promo?order=terbaru'
