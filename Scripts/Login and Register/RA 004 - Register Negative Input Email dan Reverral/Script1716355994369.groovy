...
WebUI.setText(findTestObject('Login Register Component/Input_Kode Reveral'), reverral)

WebUI.scrollToElement(findTestObject('Login Register Component/Checklist setuju dengan SK'), 0)

if (tanggal_lahir.toString().equalsIgnoreCase('y')) {
...
WebUI.waitForElementVisible(findTestObject('Login Register Component/Checklist setuju dengan SK'), 0)

if (checkbox_setuju.toString().equalsIgnoreCase('y')) {
...
WebUI.verifyElementPresent(findTestObject('Login Register Component/Label_Alert Error Email'), 0)

WebUI.verifyElementPresent(findTestObject('Login Register Component/Label_Alert Error Refferal'), 0)
