...
WebUI.scrollToElement(findTestObject('used car/verify used car detail reco'), 7)
...
// --- Jalankan ---
geserSampaiMentok("used car/RightCV_usedCar") // geser kanan
geserSampaiMentok("used car/LeftCV_usedCar")  // geser kiri
