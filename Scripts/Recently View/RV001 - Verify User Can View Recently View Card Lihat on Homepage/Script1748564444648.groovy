...
WebUI.scrollToElement(findTestObject('Homepage Recently View/recently view - lihat card - car name'), 0)
...
if ((car_name_recently_view != null) && !(car_name_recently_view.trim().isEmpty())) {
    WebUI.comment('car_name_recently_view berhasil dibaca: ' + car_name_recently_view)
} else {
    WebUI.comment('car_name_recently_view kosong')
}

WebUI.comment('Actual (car_name_recently_view): ' + car_name_recently_view)

WebUI.verifyMatch(car_name_recently_view, car_name, false)
