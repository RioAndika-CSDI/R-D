...
WebUI.callTestCase(findTestCase('Recently View/RV003 - Verify User Can View Recently View Card Simulasi Kredit on Homepage'), 
...
String expected_url = 'https://www.seva.id/kalkulator-kredit/'
