...
'pilih asuransi'
WebUI.click(findTestObject('Page_Kalkulator Kredit Mobil SEVA - Hitung Kemampuan Finansial Kamu/value_dropdown_pilih_asuransi', 
        [('pilih_asuransi') : pilih_asuransi]))

WebUI.click(findTestObject('Page_Kalkulator Kredit Mobil SEVA - Hitung Kemampuan Finansial Kamu/button_Terapkan Promo dan Asuransi'))
