...
WebUI.scrollToElement(findTestObject('Loan Calculator/Page_SEVA - Beli Mobil Terbaru Dengan Cicil_d51314/Yuk SEVA_label'), 
    0)
...
WebUI.callTestCase(findTestCase('Loan Calculator/LC002 - VerifyUserCanInputLoanCalculatorForm'), [('kota') : 'Jakarta Pusat'
        , ('brand') : 'Toyota', ('bayar') : 'ADDM', ('open_browser') : '0', ('car_name') : 'Toyota All New Agya', ('close_browser') : '1'], 
