...
WebUI.setText(findTestObject('Page_Kalkulator Kredit Mobil SEVA - Hitung Kemampuan Finansial Kamu/input_DP'), '2000000000')
...
WebUI.verifyElementVisible(findTestObject('Page_Kalkulator Kredit Mobil SEVA - Hitung Kemampuan Finansial Kamu/error_message_dp_maksimal'))
