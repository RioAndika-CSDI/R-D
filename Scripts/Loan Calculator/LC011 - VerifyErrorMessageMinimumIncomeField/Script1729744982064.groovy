...
WebUI.setText(findTestObject('Kualifikasi-Kredit/Loan-Calculator/input_pendapatan'), '100000')

WebUI.click(findTestObject('Kualifikasi-Kredit/Loan-Calculator/kategori_umur'))

WebUI.verifyElementVisible(findTestObject('Page_Simulasi Kredit Mobil Daihatsu All New Ayla 2024 OTR Jakarta Pusat. Promo Oktober  SEVA/pendapatan_Pendapatan yang kamu masukkan terlalu rendah'))
