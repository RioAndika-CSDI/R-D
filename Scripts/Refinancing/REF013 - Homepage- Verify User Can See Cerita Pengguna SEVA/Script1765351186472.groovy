...
WebUI.scrollToElement(findTestObject('HomeRefinancing/ceritapengguna_refinancing'), 5)

WebUI.delay(5)

WebUI.click(findTestObject('HomeRefinancing/card_ceritapengguna_seva'))

WebUI.delay(10)

WebUI.verifyElementPresent(findTestObject('HomeRefinancing/card_ceritapengguna_seva'), 5)
