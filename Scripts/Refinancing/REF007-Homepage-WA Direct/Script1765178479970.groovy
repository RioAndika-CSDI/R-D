...
WebUI.scrollToElement(findTestObject('HomeRefinancing/responsive mode/contoh simulasi'), 2)

WebUI.delay(5)

WebUI.click(findTestObject('HomeRefinancing/responsive mode/wa direct'), FailureHandling.STOP_ON_FAILURE)
