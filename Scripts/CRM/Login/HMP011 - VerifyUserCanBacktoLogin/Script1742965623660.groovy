...
WebUI.verifyElementClickable(findTestObject('CRM/Login/cta_BackToLogin'))

WebUI.click(findTestObject('CRM/Login/cta_BackToLogin'))
...
WebUI.verifyElementVisible(findTestObject('CRM/Login/txtLogin'))
