...
WebUI.verifyElementClickable(findTestObject('CRM/Login/cta_Forgot Password'))

WebUI.click(findTestObject('CRM/Login/cta_Forgot Password'))

'Retrieves the current page URL.'
currentUrl = WebUI.getUrl()

'Sets the expected URL for the "Customized Leads Group" page.'
expectedUrl = 'https://crm-fe.prod.seva.id/forgot-password'
