...
WebUI.click(findTestObject('Page_CRM_new/Page_Assignment/new/a_Task Assignment'))

WebUI.click(findTestObject('Page_CRM_new/Page_Assignment/div_Task Assignment'))
