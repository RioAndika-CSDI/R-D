...
WebUI.verifyElementVisible(findTestObject('Account Management Page/Page_Login SEVA CRM/field_email'))
...
WebUI.verifyElementVisible(findTestObject('Account Management Page/Page_Login SEVA CRM/field_password'))
...
WebUI.verifyElementVisible(findTestObject('Account Management Page/Page_Login SEVA CRM/button_login'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Account Management Page/Page_SEVA CRM Homepage - SEVA CRM/menu_user'))

WebUI.click(findTestObject('Object Repository/Account Management Page/Page_SEVA CRM Homepage - SEVA CRM/menu_user'))

'Verify that the user is on the "Account Management" page.'
WebUI.verifyElementText(findTestObject('Account Management Page/page_tittle'), 'Account Management')

'Click in any element to hide sidebar menu.'
WebUI.click(findTestObject('Account Management Page/element_Header'))
