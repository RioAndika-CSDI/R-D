...
WebUI.verifyElementVisible(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'))

'Search by "Leads Group" column.'
WebUI.setText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'), 'N398')
...
WebUI.clearText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'))

'Search by "Category" column.'
WebUI.setText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'), 'New Car')
...
WebUI.setText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'), 'SEVA Car Search Page Form')
...
WebUI.setText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'), 'Google SEM')
...
WebUI.setText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/field_Search'), 'XYZ@#@!')

WebUI.delay(3)

'Verify "No Data" message is visible'
WebUI.verifyElementVisible(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/No Data Message'))

'Verify" No Data" message content is correct'
WebUI.verifyElementText(findTestObject('Leads Group/Page_Leads Group - SEVA CRM/No Data Message'), 'There is nothing to be shown here.')
