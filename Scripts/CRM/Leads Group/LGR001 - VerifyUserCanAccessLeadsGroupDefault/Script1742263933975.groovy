...
'Verify that the user is on the "Default" page.'
WebUI.verifyElementText(findTestObject('CRM/Bucket Management/Leads Group/txt_Default'), 'Default')

'Retrieves the current page URL.'
currentUrl = WebUI.getUrl()

'Sets the expected URL for the "Default Leads Group" page.'
