...
WebUI.setText(findTestObject('CRM/Create QL Refinancing/input__nikBorrower'), '88')

WebUI.verifyElementVisible(findTestObject('CRM/Create QL Refinancing/txt_ErrorNikBorrower'), FailureHandling.STOP_ON_FAILURE)
