...
WebUI.setText(findTestObject('CRM/Create QL Refinancing/input__phone'), '8')

WebUI.verifyElementVisible(findTestObject('CRM/Create QL Refinancing/txt_Phone must be at least 8 characters (1)'), 
