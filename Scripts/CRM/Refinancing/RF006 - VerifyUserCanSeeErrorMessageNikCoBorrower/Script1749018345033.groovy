...
WebUI.setText(findTestObject('CRM/Create QL Refinancing/input__nikCoBorrower'), '88')

WebUI.verifyElementVisible(findTestObject('CRM/Create QL Refinancing/txt_ErrorNikCoBorrower'), FailureHandling.STOP_ON_FAILURE)
