...
WebUI.verifyElementVisible(findTestObject('Object Repository/Account Management Page/CRM049/Page_User Account - SEVA CRM/button_Previous page'))

'Verify "Next Page" button is visible.'
WebUI.verifyElementVisible(findTestObject('Account Management Page/CRM049/Page_User Account - SEVA CRM/button_Next page'))

'Verify page number is visible.'
WebUI.verifyElementVisible(findTestObject('Object Repository/Account Management Page/CRM049/Page_User Account - SEVA CRM/page_Number'))
...
'Back to page 1'
WebUI.click(findTestObject('Object Repository/Account Management Page/CRM049/Page_User Account - SEVA CRM/button_Previous page'))
