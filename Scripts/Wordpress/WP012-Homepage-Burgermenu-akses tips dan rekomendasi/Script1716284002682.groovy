...
WebUI.click(findTestObject('Homepage - Burger menu/Artikel-tips dan rekomendasi'))

WebUI.waitForElementPresent(findTestObject('Page_Artikel Tips  Rekomendasi  SEVA/Breadcrumb tips rekomendasi'), 400)
