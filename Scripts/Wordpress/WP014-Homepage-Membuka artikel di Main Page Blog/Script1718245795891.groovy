...
//WebUI.click(findTestObject('Object Repository/Page_Lihat Semua artikel/BacaJuga'))
//
//WebUI.verifyElementHasAttribute(findTestObject('Object Repository/Page_Lihat Semua artikel/Verify_BacaJuga'), 0)
