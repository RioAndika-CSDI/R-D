...
WebUI.setText(findTestObject('Page_Lihat Semua artikel/Page Join Yuk/input email'), 'hilmy.azizah@acc.co.id')

WebUI.click(findTestObject('Page_Lihat Semua artikel/Page Join Yuk/klik subscribe'))

WebUI.waitForElementPresent(findTestObject('Page_Lihat Semua artikel/Page Join Yuk/label success email'), 15)

WebUI.getText(findTestObject('Page_Lihat Semua artikel/Page Join Yuk/label success email'))
