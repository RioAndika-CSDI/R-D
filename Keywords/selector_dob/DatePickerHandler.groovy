...
public class DatePickerHandler {
	...
	def selectDate(String dob_year, String dob_month, String dob_day) {
		...
		WebUI.click (findTestObject('Object Repository/Profile/Profile_Page/button_dob'))
		...
		WebUI.click(findTestObject('Object Repository/Profile/Profile_Page/cta_Simpan_Pick Date'))
	}
